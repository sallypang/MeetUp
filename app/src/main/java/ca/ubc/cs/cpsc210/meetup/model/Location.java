...
public class Location {
	...
	public Location(LatLon latLon) {
		this.latLon = latLon;
		displayText = "default";
        // if i pass into parameter, an essential property so like the reason to create this obj in the first place
        // things that are internal and user probably wont care about, can initalized locally
	}
